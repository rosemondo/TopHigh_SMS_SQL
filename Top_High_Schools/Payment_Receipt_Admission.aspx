<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Payment_Receipt_Admission.aspx.vb" Inherits="Top_High_Schools.Payment_Receipt_Admission" %>
            ...
            <tr>
                <td colspan="5" class="auto-style5">
                    <table align="center" class="auto-style3">
                        ...
                        <tr>
                            <td style="text-align: justify">
                                <asp:Label ID="Label8" runat="server" Text="Admission Fee / Bill Due" Font-Size="Small"></asp:Label>
                            </td>
                            <td style="text-align: right">
