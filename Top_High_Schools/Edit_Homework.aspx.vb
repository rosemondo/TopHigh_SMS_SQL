...
Public Class Edit_Homework
    ...
    Protected Sub ShowStudentData()
        ...
        Try
            ...
            Dim connetionString As String = sCon
            Dim cnn As SqlConnection = New SqlConnection(connetionString)
            Dim cmd As New SqlCommand() With {.CommandType = CommandType.StoredProcedure, .CommandText = "Get_home_work_Data"}
            'insert product
            ...
            If (dr.Read() = True) Then
                ...
                txtexe1.Text = dr.Item("homework_1")
                txtexe2.Text = dr.Item("homework_2")
                txtexe3.Text = dr.Item("homework_3")
                txtexe4.Text = dr.Item("homework_4")
                txttotals.Text = dr.Item("homework_total")
    ...
    Protected Sub InsertAssesment(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim connetionString As String = sCon
            Dim cnn As SqlConnection = New SqlConnection(connetionString)
            Dim cmd As New SqlCommand() With {.CommandType = CommandType.StoredProcedure, .CommandText = "Update_Home_Work"}
        ...
        Response.Redirect("Project_Home_Work.aspx")
