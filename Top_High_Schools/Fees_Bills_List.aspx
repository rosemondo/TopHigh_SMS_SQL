<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Fees_Bills_List.aspx.vb" Inherits="Top_High_Schools.Fees_Bills_List" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList ID="ddlClass" runat="server" CssClass="form-control" ClientIDMode="Static" OnSelectedIndexChanged="ddlClass_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                                <asp:HiddenField ID="txtclassid" runat="server" />
                                <asp:HiddenField ID="txtclasstypeid" runat="server" />
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:Repeater ID="rptFeeBill" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblTuition" runat="server" Text='<%# Eval("Tuition Fee") %>' />
