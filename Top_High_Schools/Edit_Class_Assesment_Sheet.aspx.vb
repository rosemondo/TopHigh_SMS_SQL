...
Public Class Edit_Class_Assesment_Sheet
    ...
    Protected Sub ShowStudentData()
        ...
        Try
            ...
            Dim connetionString As String = sCon
            Dim cnn As SqlConnection = New SqlConnection(connetionString)
            Dim cmd As New SqlCommand() With {.CommandType = CommandType.StoredProcedure, .CommandText = "Get_Class_Assemt_Data"}
            'insert product
            ...
            If (dr.Read() = True) Then
                ...
                txtexe1.Text = dr.Item("class_exe_1")
                txtexe2.Text = dr.Item("class_exe_2")
                txtexe3.Text = dr.Item("class_exe_3")
                txtexe4.Text = dr.Item("class_exe_4")
                txttotals.Text = dr.Item("class_total")
    ...
    Protected Sub InsertAssesment()
        ...
        Try
            ...
            Dim connetionString As String = sCon
            Dim cnn As SqlConnection = New SqlConnection(connetionString)
            Dim cmd As New SqlCommand() With {.CommandType = CommandType.StoredProcedure, .CommandText = "Update_Class_Assemt"}
        ...
        Response.Redirect("Class_Assesment_Sheet.aspx")
    ...
    Protected Sub CheckClass2()
        ...
        Try
            ...
            Else
                ...
                Response.Write("<script type=""text/javascript"">alert(""Please you have no access to class data."");</script")
    ...
    Protected Sub Get_Exams_Report_List()
        ...
        Try
            ...
            Using con As SqlConnection = New SqlConnection(constr)
                ...
                Using cmd As SqlCommand = New SqlCommand("Get_class_assesment_rep", con)
    ...
    Protected Sub Get_Exams_Report_List_Search()
        ...
        Try
            ...
            Using con As SqlConnection = New SqlConnection(constr)
                ...
                Using cmd As SqlCommand = New SqlCommand("Get_class_assesment_rep_search", con)
    ...
    Protected Sub GetValue(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Response.Redirect("Edit_Class_Assesment_Sheet.aspx")
