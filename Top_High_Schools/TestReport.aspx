<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TestReport.aspx.vb" Inherits="Top_High_Schools.TestReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                        ...
                                        <thead>
                                            ...
                                            <asp:Table ID="tbstudinfo" runat="server" GridLines="Both" Style="width: 100%">
                                                <asp:TableRow>
                                                    ...
                                                    </asp:TableCell></asp:TableRow></asp:Table><tr>
                                                <td colspan="7">
                                                    <hr style="border: thin dotted #000000" />
                                                </td>
                                            </tr>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <h5>LEARNER'S TERMINAL REPORT</h5></div><div class="col-md-4">
                                                </div>
                                            </div>
                                            ...
                                            <asp:Repeater ID="rptRepoDetails" runat="server">
                                                ...
                                                <HeaderTemplate>
                                                    <table id="students" class="table table-bordered table-striped" cellspacing="0" width="100%" style="border: thin solid black; color: black">
                                                        <thead style="background-color: #16b60e; color: yellow; border: thin">
                                                            <tr>
                                                                <th scope="col" align="left" style="font-size: small" id="thsub">Subject</th><th scope="col" align="left" style="font-size: small" id="thcscore">Class Score 50%</th><th scope="col" align="left" style="font-size: small" id="thescore">Exams Score 50%</th><th scope="col" align="left" style="font-size: small" id="thtotal">Total 100%</th><th scope="col" align="left" style="font-size: small" id="thgrade">Grade</th><th scope="col" align="left" style="font-size: small" id="thsubpos">Subject Position</th><th scope="col" align="left" style="font-size: small" id="thremarks">Remarks</th></tr></thead><tbody>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <tr>
                                                ...
                                                <table class="auto-style1" id="tbbills" width="100%">
                                                    <tr>
                                                        <td style="border: thin solid #000000">
                                                            <asp:Label ID="Label13" runat="server" Text="Attendance :" Font-Size="Small" Style="padding: 10px"></asp:Label></td><td style="border: thin solid #000000">
                                                            <asp:Label ID="lblattendace" runat="server" Text='<%# Eval("tot_count") %>' Font-Size="Small" Style="padding: 25px"></asp:Label><asp:Label ID="Label14" runat="server" Text="Out of  :" Font-Size="Small" Style="padding: 15px"></asp:Label><asp:Label ID="lbloutof" runat="server" Text="0" Font-Size="Small" Style="padding: 25px"></asp:Label></td><td style="border: thin solid #000000" colspan="3">
                                                            <asp:Label ID="Label15" runat="server" Text="Promoted To :" Font-Size="Small" Style="padding: 25px"></asp:Label></td><td style="border: thin solid #000000">
                                                            <asp:Label ID="lblpromo" runat="server" Text="" Font-Size="Small" Style="padding: 25px"></asp:Label></td></tr><tr>
                                                        <td style="border: thin solid #000000">
                                                            <asp:Label ID="Label29" runat="server" Font-Size="Small" Style="padding: 10px" Text="Class teacher's remarks :"></asp:Label></td><td colspan="5" style="border: thin solid #000000">
                                                            <asp:Label ID="lblclassteacherrec" runat="server" Font-Size="Small" Text=""></asp:Label></td></tr><tr>
                                                        <td style="border: thin solid #000000">
                                                            <asp:Label ID="Label30" runat="server" Font-Size="Small" Style="padding: 10px" Text="Principal's remarks :"></asp:Label></td><td colspan="5" style="border: thin solid #000000">
                                                            <asp:Label ID="lblprincrec" runat="server" Font-Size="Small" Text=""></asp:Label></td></tr><tr>
                                                        <td style="border: thin solid #000000">
                                                            <asp:Label ID="Label31" runat="server" Font-Size="Small" Style="padding: 10px" Text="Next term school fees :"></asp:Label></td><td style="border: thin solid #000000">
                                                            <asp:Label ID="lblnextfees" runat="server" Font-Size="Small" Style="padding: 25px" Text="0"></asp:Label></td><td style="border: thin solid #000000">
                                                            <asp:Label ID="Label16" runat="server" Font-Size="Small" Style="padding: 10px" Text="Arreas of school fees :"></asp:Label></td><td colspan="3" style="border: thin solid #000000">
                                                            <asp:Label ID="lblarreas" runat="server" Font-Size="Small" Style="padding: 25px" Text="0"></asp:Label></td></tr><tr>
                                                        <td style="border: thin solid #000000">
                                                            <asp:Label ID="Label32" runat="server" Font-Size="Small" Style="padding: 10px" Text="School fees for next term"></asp:Label></td><td style="border: thin solid #000000">
                                                            <asp:Label ID="Label33" runat="server" Font-Size="Small" Style="padding: 10px" Text="School fees + Arrears = :"></asp:Label></td><td colspan="2" style="border: thin solid #000000">
                                                            <asp:Label ID="lblduefees" runat="server" Font-Size="Small" Style="padding: 25px" Text="0"></asp:Label></td><td colspan="2" style="border: thin solid #000000">&nbsp;</td></tr></table><hr /><div>
                                                    <asp:Label ID="Label6" runat="server" Text="NOTE:" Font-Bold="true" ForeColor="Black"></asp:Label><asp:TextBox ID="lblnote" CssClass="form-control" runat="server" Text="" TextMode="MultiLine" Width="100%"></asp:TextBox></div></div></ItemTemplate><FooterTemplate>
                                    <tr>
                                        <td colspan="7">
                                            <hr style="border: thin dotted #000000" />
                                        </td>
    ...
    <asp:Label ID="lblmyacayear" runat="server" Text="0" Font-Size="Small" Style="padding: 15px" Visible="false"></asp:Label><asp:Label ID="lblmyacaterm" runat="server" Text="0" Font-Size="Small" Style="padding: 15px" Visible="false"></asp:Label><script type="text/javascript">
