...
Public Class Edit_Exams
    ...
    Protected Sub ShowStudentData()
        ...
        Try
            ...
            Dim connetionString As String = sCon
            Dim cnn As SqlConnection = New SqlConnection(connetionString)
            Dim cmd As New SqlCommand() With {.CommandType = CommandType.StoredProcedure, .CommandText = "Get_exams_sheet_Data"}
            'insert product
            ...
            If (dr.Read() = True) Then
                ...
                txtexe1.Text = dr.Item("exams_score")
                txtlectremarks.Text = dr.Item("teachers_remarks")
                txtprincipalremarks.Text = dr.Item("princ_remarks")
    ...
    Protected Sub InsertAssesment(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim connetionString As String = sCon
            Dim cnn As SqlConnection = New SqlConnection(connetionString)
            Dim cmd As New SqlCommand() With {.CommandType = CommandType.StoredProcedure, .CommandText = "Update_Exams"}
            cmd.Parameters.Add("@exams_score", SqlDbType.Float).Value = txtexe1.Text
        ...
        Response.Redirect("Exams_Sheet.aspx")
    ...
    Protected Sub Get_Exams_Report_List()
        ...
        Try
            ...
            Using con As SqlConnection = New SqlConnection(constr)
                ...
                Using cmd As SqlCommand = New SqlCommand("Get_exams_rep", con)
    ...
    Protected Sub Get_Exams_Report_List_Search()
        ...
        Try
            ...
            Using con As SqlConnection = New SqlConnection(constr)
                ...
                Using cmd As SqlCommand = New SqlCommand("Get_exems_rep_search", con)
    ...
    Protected Sub GetValue(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Response.Redirect("Edit_Exams.aspx")
