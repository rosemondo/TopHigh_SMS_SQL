...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:DropDownList ID="dplStudent" runat="server" CssClass="form-control" ClientIDMode="Static" AutoPostBack="true" OnSelectedIndexChanged="GetMYID" requide="true"></asp:DropDownList>
    ...
    <div class="row" id="phrow3">
        ...
        <div class="col-md-6">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h5 class="card-title" id="upf">Upload Leaner's Photo</h5>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
    ...
    <script type="text/javascript">
        ...
        $("#btnSave").click(function () {
            ...
            var contat = $.trim($('#<%=dplStudent.ClientID %>').val());
            $.ajax({
                type: "POST",
                url: "/Edit_Photo.aspx/SaveCapturedImage",
                data: "{data: '" + $("#imgCapture")[0].src + "','stuid':'" + stuid + "', 'studcoe':'" + studcoe + "', 'contat':'" + contat + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
                    window.location.href = "/Edit_Photo.aspx";
                }
            });
