...
Public Class Class_Assesment_Sheet
    ...
    Protected Sub InsertAssesment(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim cnn As SqlConnection = New SqlConnection(connetionString)
            Dim cmd As New SqlCommand() With {.CommandType = CommandType.StoredProcedure, .CommandText = "Insert_class_assesment"}
            cmd.Parameters.Add("@stud_id", SqlDbType.VarChar).Value = txtstsudid.Value
            cmd.Parameters.Add("@class_id", SqlDbType.VarChar).Value = txtclassid.Value
            cmd.Parameters.Add("@sub_code", SqlDbType.VarChar).Value = txtcourseid.Value
    ...
    Protected Sub Get_Exams_Report_List_Search(sender As Object, e As EventArgs)
