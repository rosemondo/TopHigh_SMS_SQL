<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Income_Tax_Entry.aspx.vb" Inherits="Top_High_Schools.Income_Tax_Entry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4" id ="myhd">
        <h4 class="h4 mb-0 text-gray-800">Income Tax Level</h4>
        <a href="Income_Tax_Entry.aspx" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="dvgssnit" runat="server" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Entry Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblname" runat="server" Text='<%# Eval("entry_name") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Lower Limit">
                                            <ItemTemplate>
                                                <asp:Label ID="lbllower" runat="server" Text='<%# Eval("lower_lim_val", "{0:N2}") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Upper Limit">
                                            <ItemTemplate>
                                                <asp:Label ID="lblupper" runat="server" Text='<%# Eval("upper_lim_val", "{0:N2}") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Rate">
                                            <ItemTemplate>
                                                <asp:Label ID="lblrate" runat="server" Text='<%# Eval("inc_tax_rate", "{0:N2}") %>'></asp:Label>
                                ...
                                <asp:Panel ID="pnlAddEdit" runat="server" CssClass="modalPopup" Style="display: none">
                                    <asp:Label Font-Bold="true" ID="Label4" runat="server" Text="Income Entry Level"></asp:Label>
                                    <br />
                                    <table align="center">
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label2" runat="server" Text="Entry Name"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtentname" runat="server"></asp:TextBox>
                                                <asp:TextBox ID="txtid" Width="40px" MaxLength="5" runat="server" Visible="false"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label3" runat="server" Text="Lower Limit Value"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtlowlimval" runat="server" Text="0.00"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label5" runat="server" Text="Upper Limit Value"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtupplimval" runat="server" Text="0.00"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                ...
                                <asp:Button ID="Button1" runat="server" Text="Refresh" CssClass="btn btn-primary"/>
                            </ContentTemplate>
                            <Triggers>
