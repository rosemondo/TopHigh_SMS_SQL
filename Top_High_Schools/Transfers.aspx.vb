...
Public Class Transfers
        ...
        Using con As SqlConnection = New SqlConnection(sCon)
            Using cmd As SqlCommand = New SqlCommand("GetBankName")
                ...
                Try
                    ...
                    dplbnkto.DataSource = ds
                    dplbnkto.DataTextField = "bank"
                    dplbnkto.DataValueField = "bank"
                    dplbnkto.DataBind()
        ...
        Using con As SqlConnection = New SqlConnection(sCon)
            Using cmd As SqlCommand = New SqlCommand("GetAcName")
                ...
                Try
                    ...
                    ddlgen.DataTextField = "accname"
                    ddlgen.DataValueField = "accname"
                    ddlgen.DataBind()
    ...
    <WebMethod()>
    Public Shared Function insert_withdraw_from(ByVal txtdepdate As Date, ByVal dplacname As String, ByVal txtdepamt As Double, ByVal txtacnum As String, ByVal txtdepdes As String, ByVal dplbankname As String) As Boolean
    ...
    <WebMethod()>
    Public Shared Function insert_deposit_to(ByVal txtdepdate As Date, ByVal ddlgen As String, ByVal txtdepamt As Double, ByVal txtnumto As String, ByVal txtdepdes As String, ByVal dplbnkto As String) As Boolean
        ...
        Try
            ...
            Dim cmd As New SqlCommand() With {.CommandType = CommandType.StoredProcedure, .CommandText = "insertbank"}
            cmd.Parameters.Add("@depdate", SqlDbType.Date).Value = txtdepdate
            cmd.Parameters.Add("@accname", SqlDbType.VarChar).Value = ddlgen
            cmd.Parameters.Add("@accnum", SqlDbType.VarChar).Value = txtnumto
            cmd.Parameters.Add("@details", SqlDbType.VarChar).Value = txtdepdes
            cmd.Parameters.Add("@debit", SqlDbType.Float).Value = txtdepamt
            cmd.Parameters.Add("@credit", SqlDbType.Float).Value = "0"
            cmd.Parameters.Add("@bank", SqlDbType.VarChar).Value = dplbnkto
            cmd.Connection = cnn
    ...
    <WebMethod()>
    Public Shared Function Insert_JV_Depo_Debit(ByVal txtdepdate As Date, ByVal ddlgen As String, ByVal txtdepamt As Double, ByVal txtlinkcode As String, ByVal txttimer As String, ByVal txtusers As String) As Boolean
    ...
    <WebMethod()>
    Public Shared Function Insert_JV_Depo_Credit(ByVal txtdepdate As Date, ByVal dplacname As String, ByVal txtdepamt As Double, ByVal txtlinkcode As String, ByVal txttimer As String, ByVal txtusers As String) As Boolean
