        ...
        Try
            ...
            Using con As SqlConnection = New SqlConnection(conString)
                Using sda As SqlDataAdapter = New SqlDataAdapter(cmd)
                    cmd.Connection = con
                    cmd.Parameters.Add("@CurDate", SqlDbType.Int).Value = txtsdate.Text
        ...
        Try
            ...
            Using con As SqlConnection = New SqlConnection(conString)
                Using sda As SqlDataAdapter = New SqlDataAdapter(cmd)
                    ...
                    cmd.Parameters.Add("@Date1", SqlDbType.Date).Value = txtpdate22019.Text
                    cmd.Parameters.Add("@Dateto1", SqlDbType.Date).Value = txtpdateto22019.Text
                    sda.SelectCommand = cmd
