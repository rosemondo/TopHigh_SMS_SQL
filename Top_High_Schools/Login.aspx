<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="Top_High_Schools.Login" %>
...
<body style="background: url('/BTS-Books-Feature-3.jpg'); height: 100vh; background-size: cover; display: flex; flex-direction: column; align-items: center; justify-content: center;">
    <div class="container">
        <div class="row px-3">
