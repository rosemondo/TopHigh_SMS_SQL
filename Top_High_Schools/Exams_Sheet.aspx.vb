...
Public Class Exams_Sheet
    ...
    Protected Sub InsertAssesment()
        ...
        Try
            ...
            Dim connetionString As String = sCon
            Dim cnn As SqlConnection = New SqlConnection(connetionString)
            Dim cmd As New SqlCommand() With {.CommandType = CommandType.StoredProcedure, .CommandText = "Insert_Exams"}
        ...
        txtstsudid.Value = String.Empty
        txtexe1.Text = 0
        txtlectremarks.Text = String.Empty
        txtprincipalremarks.Text = String.Empty
