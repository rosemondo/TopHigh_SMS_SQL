<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Canteen_List.aspx.vb" Inherits="Top_High_Schools.Canteen_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4" id="myhd">
        <h4 class="h4 mb-0 text-gray-800">Canteen Fees Statement</h4>
                                    ...
                                    <asp:Repeater ID="rptReportMain" runat="server" OnItemDataBound="OnItemDataBound">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lbllearners" runat="server" Text='<%# Eval("Class") %>' />
                                                        <asp:Label ID="Label2" runat="server" Text=' : Total Head : ' />
                                                        <asp:Label ID="Label3" runat="server" />
                                                        <asp:Label ID="Label1" runat="server" Text=' : Total Paid : ' />
                                                        <asp:Label ID="Label4" runat="server" />
                                                        <asp:Label ID="Label5" runat="server" Text=' : Total Unpaid : ' />
                                                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Exemption_Unpaid_List.aspx"></asp:HyperLink>
                                                ...
                                                <asp:Repeater ID="rptRepoDetails" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr style="border: thin">
                                                            <td>
                                                                <asp:Label ID="lblsubjects" Style="float: left" runat="server" Text='<%# Eval("ID") %>' /></td>
                                                            <td align="center">
                                                                <asp:Label ID="lblclass" Style="float: left" runat="server" Text='<%# Eval("Student") %>' /></td>
                                                            <td align="center">
                                                                <asp:Label ID="lblexems" Style="float: left" runat="server" Text='<%# Eval("Canteen", "{0:N2}") %>' /></td>
                                                            <td align="center">
                                                                <asp:Label ID="lbltotalexamclass" Style="float: left" runat="server" Text='<%# Eval("Status") %>' /></td>
                                                            <td align="center">
                                                ...
                                                <tr>
                                                    ...
                                                    <table align="center" class="auto-style1" border="0" cellspacing="2" style="width: 100%;">
                                                        ...
                                                        <tr>
                                                            <td></td>
                                                            <td colspan="1" style="font-weight: bold">Total Canteen Fee :</td>
                                                            <td>
                                                                <asp:Label ID="lblsum" runat="server" Text='<%# Eval("Canteen", "{0:N2}") %>' Style="font-weight: bold" /></td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                        </tr>
