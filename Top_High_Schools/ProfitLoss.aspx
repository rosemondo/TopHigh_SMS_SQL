<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ProfitLoss.aspx.vb" Inherits="Top_High_Schools.ProfitLoss" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4" id ="myhd">
        <h4 class="h4 mb-0 text-gray-800">Profit & Loss Report</h4>
    </div>

    <div class="row" id="pfrow1">
        <div class="col-md-12">
    ...
    <script type="text/javascript">
        ...
        function countdown() {
            ...
            if (seconds < 0) {
                ...
                document.getElementById("pfrow1").style.fontFamily = fontstyle;
                document.getElementById("pfrow2").style.fontFamily = fontstyle;
