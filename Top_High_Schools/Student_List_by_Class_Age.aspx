<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Student_List_by_Class_Age.aspx.vb" Inherits="Top_High_Schools.Student_List_by_Class_Age" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4" id ="smyhd">
        <h4 class="h4 mb-0 text-gray-800">Student List by Class</h4>

    </div>

    <div class="row" id ="srow1">
        <div class="col-md-12">
                        ...
                        <asp:Repeater ID="rptRepoDetails" runat="server">
                            ...
                            <ItemTemplate>
                                <tr style="border: thin">
                                    ...
                                    <td align="center">
                                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("Active") %>' Style="float:left"/>
                                    </td>
                                </tr>
    ...
    <script type="text/javascript">
        ...
        function countdown() {
            ...
            if (seconds < 0) {
                ...
                document.getElementById("smyhd").style.fontFamily = fontstyle;
                document.getElementById("srow1").style.fontFamily = fontstyle;
