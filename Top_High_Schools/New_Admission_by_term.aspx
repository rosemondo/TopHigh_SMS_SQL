<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="New_Admission_by_term.aspx.vb" Inherits="Top_High_Schools.New_Admission_by_term" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4" id ="myhd">
        <h4 class="h4 mb-0 text-gray-800">New Admission By Term</h4>
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-sm-6">
                            <label for="inputEmail3">Select Year & Term</label>
                        ...
                        <thead>
                            ...
                            <tr>
                                <td colspan="7" style="text-align: center" class="auto-style5">
                                    <asp:Label ID="Label11" runat="server" Text="New Admission By Term" Font-Bold="True" Font-Underline="true" Font-Size="large" Style="padding: 15px"></asp:Label>
                                </td>
                            </tr>
