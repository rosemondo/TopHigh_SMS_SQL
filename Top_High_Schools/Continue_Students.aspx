<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Continue_Students.aspx.vb" Inherits="Top_High_Schools.Continue_Students" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Class</label>
                                <div class="input-group">
                                     <asp:DropDownList ID="ddlClass" runat="server" CssClass="form-control" requide="true" ClientIDMode="Static" onchange="getClassID()"></asp:DropDownList>
    ...
    <br />
     ...
     <script type="text/javascript">
         ...
         function getClassID() {
             ...
             $.ajax({
                 type: "POST",
                 url: "/Continue_Students.aspx/GetMyClassID",
    ...
    <script type="text/javascript">
        ...
        $("#btnSave").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "/Continue_Students.aspx/Insertadmissionstudents",
        ...
        function Insertadmissionparentsfather() {
            ...
            var txtfatdeadalive = $.trim($('#<%=txtfatdeadalive.ClientID %>').val());

            $.ajax({
                type: "POST",
                url: "/Continue_Students.aspx/Insertadmissionparentsfather",
                data: "{'myid':'" + myid + "','mydays':'" + mydays + "','mymonth':'" + mymonth + "','myyear':'" + myyear + "','txtfathersname': '" + txtfathersname + "', 'txtaddress': '" + txtaddress + "', 'txtmobile': '" + txtmobile + "','txtfatOcupa': '" + txtfatOcupa + "', 'txtfatreligion': '" + txtfatreligion + "', 'txtfateducation': '" + txtfateducation + "','txtfatdeadalive': '" + txtfatdeadalive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
        ...
        function Insertadmissionparentsmother() {
            ...
            var txtmatdeadalive = $.trim($('#<%=txtmatdeadalive.ClientID %>').val());

            $.ajax({
                type: "POST",
                url: "/Continue_Students.aspx/Insertadmissionparentsmother",
                data: "{'myid':'" + myid + "','mydays':'" + mydays + "','mymonth':'" + mymonth + "','myyear':'" + myyear + "','txtmatname': '" + txtmatname + "', 'txtmataddress': '" + txtmataddress + "', 'txtmatmobile': '" + txtmatmobile + "','txtmatoccupation': '" + txtmatoccupation + "', 'txtmatreligion': '" + txtmatreligion + "', 'txtmateducation': '" + txtmateducation + "','txtmatdeadalive': '" + txtmatdeadalive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
        ...
        function Insertadmissiondeclaration() {
            ...
            $.ajax({
                type: "POST",
                url: "/Continue_Students.aspx/Insertadmissiondeclaration",
                data: "{'myid':'" + myid + "','mydays':'" + mydays + "','mymonth':'" + mymonth + "','myyear':'" + myyear + "','txtname': '" + txtname + "', 'txtdate': '" + txtdate + "', 'txtsign': '" + txtsign + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
                    InsertCurrentClass()
        ...
        function InsertCurrentClass() {
            ...
            $.ajax({
                type: "POST",
                url: "/Continue_Students.aspx/InsertCurrentClass",
                data: "{admidate: '" + admidate + "','txtclassid':'" + txtclassid + "','myid':'" + myid + "','mydays':'" + mydays + "','mymonth':'" + mymonth + "','myyear':'" + myyear + "','ddlacaterm':'" + ddlacaterm + "','ddlacayear':'" + ddlacayear + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
                    SaveImage()
        ...
        function SaveImage() {
            ...
            $.ajax({
                type: "POST",
                url: "/Continue_Students.aspx/SaveCapturedImage",
